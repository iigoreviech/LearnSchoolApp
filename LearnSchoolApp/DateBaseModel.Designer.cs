// Создание кода T4 для модели "C:\Users\igore\Downloads\ИзКолледжа_Шимченко_Практика\Практика_Шимченко\ИзДому_Шимченко_Практика\LearnSchoolApp\DateBaseModel.edmx" включено. 
